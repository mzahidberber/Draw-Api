    ...
    internal class BaseTitleMapping : IEntityTypeConfiguration<BaseTitle>
    {
        public void Configure(EntityTypeBuilder<BaseTitle> builder)
        {
            ...
            builder.HasData(
                ...
                new BaseTitle { Id = 22, IndexId = 2, TextUrl1 = "SetElementsId.html", Title = "Set Elements Id", ResponeseType = "PUT", Header = "/Draw/setElementsId", Body = "SetElementsId.json", MainTitleId = 10 },
                ...
                new BaseTitle { Id = 26, IndexId = 2, TextUrl1 = "DrawBoxes.html", Title = "Draw Boxes", ResponeseType = "GET", Header = "/DrawBox/drawBoxes", MainTitleId = 11 },
