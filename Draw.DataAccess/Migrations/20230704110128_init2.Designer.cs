...
namespace Draw.DataAccess.Migrations
{
    ...
    [Migration("20230704110128_init2")]
    partial class init2
    {
            ...
            modelBuilder.Entity("Draw.Entities.Concrete.Draw.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "eb833f92-e6a9-4039-8838-fdfb7056f0f4",
                            ConcurrencyStamp = "212645a0-0e13-4af8-9eed-aef30ba3889c",
                            Name = "admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "9957f936-7f7f-4356-81e1-74d3ca5ce2e0",
                            ConcurrencyStamp = "8dbe362b-da0b-48cd-9e3f-b1250c31f8e4",
                            Name = "manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "8af64394-cf77-41ae-aed4-1de81fa67406",
                            ConcurrencyStamp = "8c1546bd-cb9e-42c7-86a5-afcd46e07075",
                            Name = "user",
                            NormalizedName = "USER"
                        });
                });
