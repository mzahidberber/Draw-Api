    ...
    public class Tests
    {
        ...
        public void Test2()
        {
            ...
            var list = new List<ElementDTO> { 
                new ElementDTO { ElementId=1,LayerId=1,ElementTypeId=3,PenId=1 } ,
                new ElementDTO { ElementId=2,LayerId=1,ElementTypeId=1,PenId=2 } ,
                new ElementDTO { ElementId=29,LayerId=1,ElementTypeId=1,PenId=1 } 
            };
